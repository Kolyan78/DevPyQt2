...
class MyApp(QtWidgets.QWidget):
    ...
    def initThreads(self):
        ...
        self.timerThread.finished.connect(self.timesThreadFinished)
    ...
    def initUi(self):
        ...
        self.lineEditStart.setPlaceholderText("Ingrese el número de segundos")

        self.pushButtonStart = QtWidgets.QPushButton()
        self.pushButtonStart.setText("Empezar")

        self.pushButtonStop = QtWidgets.QPushButton()
        self.pushButtonStop.setText("Deténgase")
    ...
    def onPushButtonStartClicked(self):
        ...
        try:
            ...
            QtWidgets.QMessageBox.warning(self, "¡Error!", f"¡El temporizador solo admite el tipo 'int' en los valores!\n"
                                                           f"Se ha establecido el valor predeterminado {self.default} segundos")
            self.lineEditStart.setText(str(self.default))
            self.timerThread.start()
            # print(self.lineEditStart.text())

    def onPushButtonStopClicked(self):
        self.timerThread.cont = False
    ...
    def timesThreadFinished(self):
        self.pushButtonStart.setEnabled(True)
        self.pushButtonStop.setEnabled(False)
        self.lineEditStart.setEnabled(True)
        self.lineEditStart.setText("")
        QtWidgets.QMessageBox.about(self, "OK", f"El temporizador se ha terminado.")
